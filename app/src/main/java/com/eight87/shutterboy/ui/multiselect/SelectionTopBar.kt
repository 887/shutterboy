...
/**
 * Phase H.2 + m3-expressive F.3 pattern 3 — selection-mode top app bar.
 *
 * Renders the count, a close (X) affordance, a "Select all" affordance, and a
 * Delete affordance. The container colour is `surfaceContainerHigh` (M3E
 * surface-tier ladder rung 4) so the bar sits visibly above the page surface
 * without leaning on shadow elevation.
 *
