...
- [ ] **E.5** Robolectric — partial: sort persistence per tab + per-folder override + fallback covered (`PhotoSortCodecTest`, 4 pure-JUnit cases; `DataStoreSortPreferencesTest`, 6 Robolectric cases against a temp-file DataStore). Drag-reorder + folder-append tests land alongside E.4.
